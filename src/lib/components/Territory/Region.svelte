...
<div class="region-info-container overflow-hidden rounded-lg bg-gray-800">
	<div class="relative h-48 w-full overflow-hidden">
		...
		/>
		<div
			class="absolute top-0 right-0 bottom-0 left-0 flex flex-col justify-between bg-gradient-to-t from-black/40 to-transparent p-4"
		>
			<div class="mb-auto flex justify-between">
				<div class="">
					<Icon text="RB" className="mr-2 bg-yellow-500" />
					<span class="text-lg font-bold text-green-400">+{regionInfo.bonus}%</span>
				</div>
				<div class="">
					<Icon text="RC" className="mr-2" />
					<span class="text-lg font-bold">{regionControl.toFixed()}/100</span>
				</div>
			</div>
